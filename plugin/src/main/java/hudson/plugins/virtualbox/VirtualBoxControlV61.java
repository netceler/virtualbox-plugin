...
public final class VirtualBoxControlV61 implements VirtualBoxControl {
    ...
    public VirtualBoxControlV61(final String hostUrl, final String userName, final Secret password) {
    ...
    public synchronized long startVm(final VirtualBoxMachine vbMachine, final String snapshotName,
        ...
        try {
            ...
            progress = machine.launchVMProcess(session, type, new ArrayList<String>(0));
